...
- 启动日期: `2026-06-02`
- 完成日期: `2026-06-02`
- 目标: 将 `1.3.2` 提升为当前正式主线, 并把下一轮承接入口从 `1.2.x` 切换到 `1.3.2`
- 详细文档: [v1.3.2-summary.md](./upgrades/v1.3.2-summary.md)
- 实施计划: [v1.3.2-plan.md](./upgrades/v1.3.2-plan.md)
- 收口锚点:
  - 上一正式版本号: `1.2.1`
  - 当前仓库正式版本号: `1.3.2`
  - Progress entry: `.agents/progress/entries/2026/2026-06-02-1.md`
- 输入来源:
  - 用户明确要求将 `1.3.2` 提升为主线
